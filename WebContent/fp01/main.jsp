...
if (letterData != null) {
	String executeData = checkData(letterData.length() != 0, letterData, fontData, colorData,
	String.valueOf(groupData));
	if (executeData != "NULL") {
		//out.println("<script> alert('내용이 전송 되었습니다.'); location.href='receive.jsp'; </script>");
		request.setAttribute("executeData", executeData);
		...
		<div class="main">
			...
			<form action="#" method="post" id="next">
				<div class="input">
					...
					<div class="textInput">
						...
						<input type="image" src="img/pot3.png" name="send" alt="send"
							id="send" onMouseOver="this.src='img/pot4.png'"
			...
			<div class="about">
				<a href="AboutPage.jsp"
					...
					<strong>About</strong>
				</a> <span style="margin-left: 50px">Why make?</span> <span
					style="margin-left: 50px">How to Use?</span> <span
					style="margin-left: 50px">Who are We?</span>
			</div>
		</div>
	</div>
